...
Error 1: In 'Data understanding' line 32 it should be str(rawDF) instead str(rawDF))

Error 2: In 'Data understanding: changing the proportions' line 72 it says propCat1, this should be propCat2.

Error 3: In 'Normalizing variables' line 92 it should be (max(x) - min(x))) instead of (max() - min(x)) on the end.

Error 4: In 'Modeling and Evaluation' line 123 there is missing a comma behind cleanDF_test_pred. So it should be cleanDF_test_pred, instead of cleanDF_test_pred
